...
useEffect(() => {
fetch('[http://127.0.0.1:8000/payment/students/](http://127.0.0.1:8000/payment/students/)')
.then((res) => res.json())
.then(setStudents)
...
// Show loading until teacher is loaded
if (!teacher) {
return <p className="text-center mt-10 text-gray-500">Loading dashboard...</p>;
}

return ( <div className="max-w-6xl mx-auto mt-20 p-4 bg-white dark:bg-gray-900 dark:text-white shadow rounded"> <h1 className="text-2xl font-semibold mb-4">🎓 Payment Management</h1>
    ...
    <div className="mb-6 p-4 border dark:border-gray-700 rounded">
      ...
      <div className="mt-6 space-y-3">
        ...
        <input
          ...
          onChange={(e) =>
            setNewPayment({ ...newPayment, reference_id: e.target.value })
          }
        />
        <input
          type="date"
