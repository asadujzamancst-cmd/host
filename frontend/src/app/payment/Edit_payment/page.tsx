...
try {
const res = await fetch(`http://127.0.0.1:8000/payment/payments/?student_id=${studentId}`);
...
try {
const res = await fetch(`http://127.0.0.1:8000/payment/payments/${id}/`, { method: "DELETE" });
...
try {
const res = await fetch(`http://127.0.0.1:8000/payment/payments/${editingPayment.id}/`, {
method: "PUT",
